...
codeunit 331 "No. Series Cop. Add Intent" implements "AOAI Function"
{
    ...
    var
        ...
        // ToolProgressDialogTextLbl: Label 'Searching for tables with number series semantically related to your query'; // TODO: Uncomment when the semantic vocabulary is ready
        ToolProgressDialogTextLbl: Label 'Searching for tables with number series related to your query'; // TODO: Remove when the semantic vocabulary is ready
    ...
    //TODO: Uncomment when the semantic vocabulary is ready
